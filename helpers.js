function init(e){
    $('<div class="modal-backdrop custom_backdrop"><img src="//codecloud.cdn.speedyrails.net/sites/590c8cb96e6f645161020000/image/gif/1493992574000/loading.gif" class="" alt=""></div>').appendTo(document.body);
